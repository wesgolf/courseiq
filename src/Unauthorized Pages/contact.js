...
import Navbar from "../Unauthorized Components/navbar"
import "../Unauthorized Styles/contact.css"
import Footer from "../Unauthorized Components/footer"
    ...
    async function handleSubmit(event) {
        ...
        if (Object.keys(newErrors).length === 0) {
            ...
            try {
                ...
                setPhoneNumber("");
                setText("");
                // You might want to set a success message to display to the user here
            } catch (e) {
                console.error("Error adding document: ", e);
                // Handle the error (e.g., by setting an error message state and displaying it to the user)
            }
        } else {
            setErrors(newErrors);
        }
